...
export const TRANSLATIONS = {
  ru: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Прямые вакансії от проверенных работодателей. Заводы, стройки, отели, уход. Без предоплаты.",
          icon: "Briefcase"
        },
        {
    ...
    budget: {
      ...
      food: {
        ...
        basketItems: ["Мясо и рыба", "Свежие овощи и фрукты", "Молочные продукты и яйца", "Крупи, хлеб, масло", "Напитки и десерты"],
    ...
    contact: {
      ...
      citizenshipPlace: "Выберите...",
      citizenshipOptions: ["РФ", "Беларусь", "Украина", "Молдова", "Грузия", "Казахстан", "Узбекистан", "Таджикистан", "Кыргызстан", "Армения", "Азербайджан", "Другое"],
      city: "Город проживания",
      cityPlace: "Например: Москва",
      languages: "Знание языков",
      languagesPlace: "Английский (базовый), Русский",
      skills: "Проф. навыки",
      skillsPlace: "Водитель, Сварщик...",
      tripDate: "Когда планируете поездку?",
      tripDatePlace: "дд.мм.гггг",
      ...
      hasRelatives: "Наличие родственников в Израиле?",
      experienceAbroad: "Опыт работы за границей",
      experiencePlace: "Нет / Польша (1 год)...",
      medicalIssues: "Особые медицинские ограничения?",
      medicalPlace: "Нет / Аллергия, давление...",
      workDuration: "Планируемый срок работы?",
      workDurationPlace: "Например: 1 год",
      notes: "Примечания / комментарии",
      notesPlace: "Дополнительная информация...",
      yes: "Да",
      no: "Нет",
  ...
  ua: {
    ...
    contact: {
      ...
      citizenshipPlace: "Оберіть...",
      citizenshipOptions: ["РФ", "Білорусь", "Україна", "Молдова", "Грузія", "Казахстан", "Узбекистан", "Таджикистан", "Киргизстан", "Вірменія", "Азербайджан", "Інше"],
      city: "Місто проживання",
      cityPlace: "Наприклад: Київ",
      languages: "Знання мов",
      languagesPlace: "Англійська (базова), Російська",
      skills: "Проф. навички",
      skillsPlace: "Водій, Зварювальник...",
      tripDate: "Коли плануєте поїздку?",
      tripDatePlace: "дд.мм.рррр",
      ...
      hasRelatives: "Наявність родичів в Ізраїлі?",
      experienceAbroad: "Досвід роботи за кордоном",
      experiencePlace: "Ні / Польща (1 рік)...",
      medicalIssues: "Особливі медичні обмеження?",
      medicalPlace: "Ні / Алергія, тиск...",
      workDuration: "Планований термін роботи?",
      workDurationPlace: "Наприклад: 1 рік",
      notes: "Примітки / коментарі",
      notesPlace: "Додаткова інформація...",
      yes: "Так",
      no: "Ні",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Вартість розраховується індивідуально і вираховується рівними частинами з вашої зарплаты (можна розбити на 1-2 місяці). По прильоту ви оплачуєте лише аванс юристу за оформлення легалізації."
        }
      ] as FAQItem[]
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      citizenshipPlace: "Select...",
      citizenshipOptions: ["Russia", "Belarus", "Ukraine", "Moldova", "Georgia", "Kazakhstan", "Uzbekistan", "Tajikistan", "Kyrgyzstan", "Armenia", "Azerbaijan", "Other"],
      city: "City of Residence",
      cityPlace: "Example: New York",
      languages: "Languages",
      languagesPlace: "English (Basic), Russian",
      skills: "Skills",
      skillsPlace: "Driver, Welder...",
      tripDate: "Planned Trip Date?",
      tripDatePlace: "dd.mm.yyyy",
      ...
      hasRelatives: "Relatives in Israel?",
      experienceAbroad: "Work Experience Abroad",
      experiencePlace: "None / Poland (1 year)...",
      medicalIssues: "Medical Restrictions?",
      medicalPlace: "None / Allergies...",
      workDuration: "Planned Work Duration?",
      workDurationPlace: "Example: 1 year",
      notes: "Notes / Comments",
      notesPlace: "Additional info...",
      yes: "Yes",
      no: "No",
